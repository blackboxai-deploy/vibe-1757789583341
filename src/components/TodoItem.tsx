...
export const TodoItem: React.FC<TodoItemProps> = ({
  ...
  return (
    <div 
      className={`
        p-4 transition-all duration-200 hover:bg-white/50
          ...
          {isEditing ? (
            ...
            <div>
              ...
              <div className="flex items-center space-x-3 mt-3">
                ...
                {/* Weekend Badge */}
                {task.isWeekend && (
                  <div className="inline-flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium bg-pink-100 text-pink-700">
                    <span>🌴</span>
                    <span>Weekend</span>
                  </div>
                )}
